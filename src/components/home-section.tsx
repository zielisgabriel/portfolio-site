...
export function HomeSection({ dict }: HomeSectionProps) {
    return (
        <section id="home" className="relative min-h-screen flex items-center justify-center animate-fade-in">
            <div className="lg:grid lg:grid-cols-2 flex items-center max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <div className="space-y-6 text-center lg:text-start lg:block">
                    ...
                    <p className="text-xl sm:text-xl md:text-2xl text-muted-foreground">
                        {dict.all.stack}
                    </p>
                    ...
                    <div className="flex lg:justify-start justify-center gap-4 pt-2">
                        <Link
                    ...
                    <div className="flex flex-col sm:flex-row lg:justify-start justify-center gap-2">
                ...
                <Image
                    ...
                    className="hidden lg:block animate-item-float translate-x-20 translate-y-15"
                    priority
                />
            </div>
